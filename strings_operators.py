...
print("PART 1: Equality == and Not Equal to != Operators with Strings")

# The == operator can check if two strings are equal to each other. 
# If they are equal, the Python interpreter returns a True result.
print("a string == a string: ", "a string" == "a string")
True
...
event_city = "Shanghai"
print("event_city != Shanghai: ", event_city != "Shanghai")
False
...
print("three == 3: ", "three" == 3)
False

# PART 2: The Greater Than > and Less Than < Operators

print("PART 2: The Greater Than > and Less Than < Operators")
...
# result.
print("Wednesday > Friday: ", "Wednesday" > "Friday")
True
...
print("sunbathe > suntan: ", "sunbathe" > "suntan")
False
...
print("Five < 6: ", "Five" < str(6))

# PART 3: The Greater Than or Equal To >= and Less Than or Equal To <= Operators

print("PART 3: The Greater Than or Equal To >= and Less Than or Equal To <= Operators")
