...
print("PART 1: Equality == and Not Equal To != Operators")
print("32 == 30+2: ", 32 == 30+2)   # The == operator checks if the 2 values are 
True                                # equal to each other. If they are equal, 
                                    # Python returns a True result.

print("5+10 == 6+7: ", 5+10 == 6+7)   # If the two values are not equal, as in the
False                               # expression 5+10 == 6+7 (or 15 == 13), Python          
                                    # returns a False result.


print("10-4 != 10+4: ", 10-4 != 10+4) # The != operator checks if the 2 values are
True                                # NOT equal to each other. If true, Python              
                                    # returns a True result. 


print("9/3 != 3*1: ", 9/3 != 3*1)     # In this last example, 9/3 != 3*1 (or 3 != 3)
...
print("my_variable: ", my_variable)          # Printing the variable returns the 
...
print("my_variable == 3*5: ", my_variable == 3*5)   # Printing the variable returns a Boolean 
True                        # True or False result. 

# PART 2: Greater Than > and Less Than < Operators

print("PART 2: Greater Than > and Less Than < Operators")
print("11 > 3*3: ", 11 > 3*3)         # The > operator checks if the left value is
True                    # greater than the right value. If true, it
                        # returns a True result.


print("4/2 > 8-4: ", 4/2 > 8-4)        # If the > operator finds that the left value
False                   # is NOT greater than the right value, the
                        # comparison will return a False result.


print("4/2 < 8-4: ", 4/2 < 8-4)        # The < operator checks  if the left value is
True                    # less than the right side. If true, the
                        # comparison returns a True result.


print("11 < 3*3: ", 11 < 3*3)         # If the < operator finds that the left side is False                   
...
print("PART 3: Greater Than or Equal to >= and Less Than or Equal to <= Operators")
print("12*2 >= 24: ", 12*2 >= 24)   # The >= operator checks if the left value is
...
print("18/2 >= 15: ", 18/2 >= 15)   # If the >= comparison determines that the left
False               # value is NOT greater than or equal to the
                    # right, it returns a False result.

print("12*2 <= 30: ", 12*2 <= 30)   # The <= operator checks if the left value is
...
print("15 <= 18/2: ", 15 <= 18/2)   # If the <= comparison determines that the left 
